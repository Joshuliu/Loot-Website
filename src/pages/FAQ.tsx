...
const faqItems = [
  ...
  { question: "Is my financial data secure?", answer: "Yes. Loot never stores your payment credentials or card information. All electronic transactions are processed exclusively through Apple Pay, Zelle, CashApp, Paypal, or Venmo's secure infrastructure. Loot only records the expense amounts and who owes what within your group." },
  ...
  { question: "What payment methods does Loot support?", answer: "Loot supports Apple Pay, Zelle, Paypal, Cashapp, and Venmo for instant digital settlement. You can also manually record cash payments, check payments, or bank transfers. All payment types update the group balance correctly so your records stay accurate regardless of how people choose to pay." },
